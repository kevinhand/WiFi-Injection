...
static const uint8_t u8aManagementFrame[] = {
	...
	0x00, 0x00, // Capabilities information
	0x02, 0x00, 0x00, 0x00,
...
int main(void) {
  ...
  sz = sizeof(u8aRadiotapHeader) + sizeof(struct ieee80211_hdr)+6;//management frame 140 bytes
   ...
   * the FC, hence 0x02.
   */
  fcchunk[0] = 0xb0;//(( WLAN_FC_TYPE_CONTROL << 2) | (WLAN_FC_SUBTYPE_RTS << 4));
  fcchunk[1] = 0x00;
